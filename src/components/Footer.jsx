    ...
    return (
        <div
            ...
            <p className="text-xs text-zinc-600 dark:text-zinc-400">
                &copy; MCMetrics {new Date().getFullYear()}. All rights
                reserved.
            </p>
            <div className="flex gap-4">
                <SocialLink href="https://github.com/MCMetrics" icon={GitHubIcon}>
                    Follow us on GitHub
                </SocialLink>
                <SocialLink href="https://mcmetrics.net/discord" icon={DiscordIcon}>
